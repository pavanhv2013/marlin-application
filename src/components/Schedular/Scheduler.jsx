...
const Scheduler = () => {
  ...
  const validateInputs = () => {
    ...
    if (activeTable !== 'guest' && newGuest.occurrence < new Date()) {
      newErrors.occurrence = 'Occurrence date cannot be in the past.';
    }
    return newErrors;
  };
  ...
  return (
    <div className="scheduler-containers">
      <div className="calendar-button-containers">
        ...
        <div className="p-fluid">
          ...
          {activeTable !== 'guest' && (
            <div className="p-field">
              ...
              <Calendar
                id="occurrence"
                value={newGuest.occurrence}
                onChange={(e) => setNewGuest({ ...newGuest, occurrence: e.value })}
                minDate={new Date()}
              />
              {errors.occurrence && <small className="p-error">{errors.occurrence}</small>}
            </div>
          )}
